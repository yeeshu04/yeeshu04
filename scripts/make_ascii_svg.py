...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">yeeshu04@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'yeeshu04@github:~$ whoami <tspan fill="{INK}">Y M</tspan></text>')
_status_prefix_chars = len("yeeshu04@github:~$ whoami Y M")
_cursor_x = PAD + _status_prefix_chars * 7.1
